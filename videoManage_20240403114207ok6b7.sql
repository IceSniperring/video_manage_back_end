...
--
-- Host: localhost    Database: videoManage
-- ------------------------------------------------------
...
CREATE TABLE `video` (
  ...
  `kind` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `file_path` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `post_path` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2024-04-03 11:42:07
